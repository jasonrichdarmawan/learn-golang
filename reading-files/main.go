...
func main() {
	...
	// The bufio package implements a buffered reader that may be useful both for its
	// efficiency with many small reads and because of the additional reading methods it provides.
